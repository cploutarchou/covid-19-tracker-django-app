...
from admin_panel.widgets import AdminPanelSelect
...
class OptionsAdmin(admin.ModelAdmin):
    ...
    def general_option_view(self, request):
        ...
        context['line'] = form
        return TemplateResponse(request, 'admin_panel/general_option.html',
                                context)
...
class MenuAdmin(TreeAdmin):
    ...
    change_list_template = 'admin_panel/menu_change_list.html'
    change_form_template = 'admin_panel/menu_change_form.html'
